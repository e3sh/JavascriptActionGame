...
function sce_player() {
    ...
    this.move = function (scrn, o) {
        ...
        if (zkey) {
            ...
            if (o.shot == 0) {
                ...
                o.set_object(36); o.set_object(37);
                }
                o.triger = 15;
                if (powup > 0) {
                o.set_object(6);
            ...
            if (o.shotSub == 0) {
                ...
                if (o.itemstack.length > 0) {
                    ...
                    if (w == 23) {
                        ...
                        //o.set_object(6);
                        //o.set_object_ex(20, o.x, o.y, 0, 42, w + ".");
                        o.item[23]--;
                        //    o.set_object_ex(20, o.x, o.y, 0, 42, "Bomb!");
                    }
        ...
        if (o.status == 2) {//状態が衝突の場合
            ...
            if (o.config.itemreset) {
                ...
                /*
                for (i in o.itemstack) {
                this.set_object_ex(o.itemstack[i], o.x, o.y, Math.floor(Math.random() * 360), 38);
                }
                o.itemstack = [];
                */
    ...
    function damage_gr1(scrn, o) {
        ...
        /*
        cl = {};
        cl.x = 640 - (12 * 12); //o.move_target_x//o.mouse_state.x;
        cl.y = 479 - 32 + 5; // o.move_target_y//o.mouse_state.y;
        cl.df = o.damageflag;
        cl.r = 15; // (o.frame < 90) ? (105 - o.frame) : 15;

        if (barriref) {
            cl.sr = -0.5 * Math.PI;
            cl.col = "skyblue";
        } else {
            cl.sr = ((360 * ((o.maxhp - ((o.hp < 0) ? 0 : o.hp)) / o.maxhp) - 90) * (Math.PI / 180));
            cl.col = "limegreen";
        }   
        ...
        cl.draw = function (device) {
            ...
            device.beginPath();
            device.lineWidth = 8; //(this.df) ? "10" : "3";
            device.strokeStyle = (this.df) ? "red" : this.col;
        ...
        //scrn.putFunc(cl);
        o.graphicsLayer[3].putFunc(cl);

        //scrn.putchr8(o.hp + "/" + o.maxhp, 640 - (12 * 12) - 16, 479 - 8);
